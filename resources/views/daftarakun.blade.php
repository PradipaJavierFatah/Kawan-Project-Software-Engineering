                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6 border-2 border-black">
                        <div class="py-8 px-8">
                            ...
                            <div class="mb-0">
                                ...
                                <input type="text" id="nama" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan nama kamu..." required />
                                

                                <label for="text" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit">Tempat Lahir</label>
                                <input type="text" id="tempatlahir" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Asal kelahiran..." required />
    
                                <label for="date" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit">Tanggal Lahir</label>
                                <input type="text" id="tanggallahir" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="DD/MM/YY" required />
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6 border-2 border-black">
                        <div class="py-8 px-8">
                            ...
                            <form action="{{ route('daftarakun.store') }}" method="POST">
                                @csrf
                                <div class="mb-0">
                                    <label for="nama" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit">Nama</label>
                                    <input type="text" id="nama" name="nama" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan nama kamu..." required />
                                    
                                    <label for="tempat_lahir" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit">Tempat Lahir</label>
                                    <input type="text" id="tempatlahir" name="tempat_lahir" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Asal kelahiran..." required />
        
                                    <label for="tanggal_lahir" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit">Tanggal Lahir</label>
                                    <input type="date" id="tanggallahir" name="tanggal_lahir" class="font-Kanit bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
        
                                    <label for="jenis_kelamin" class="block text-lg font-medium text-gray-900 dark:text-black font-Kanit mb-2">Jenis Kelamin</label>
                                    <div class="flex justify-between mb-2 pr-36">
                                        <div class="flex items-center">
                                            <input id="default-radio-1" type="radio" value="Pria" name="jenis_kelamin" class="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-20">
                                            <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-600">Pria</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="default-radio-2" type="radio" value="Wanita" name="jenis_kelamin" class="w-5 h-5 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-20">
                                            <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-600">Wanita</label>
                                        </div>
                                    </div>
